...
SHARE_DIR = "/usr/local/share/shadowmap/"  # fallback przed importem config
...
def open_html_report(report_path: str):
    ...
    try:
        ...
        utils.console.print(f"[red]Błąd otwierania raportu. Szczegóły: {e}[/red]")
                ...
                if choice == "1":
                    ...
                    if p1_skipped or active_urls:
                        if active_urls:
                            ...
                            Prompt.ask("\n[bold cyan]Naciśnij Enter, aby powrócić do menu...[/bold cyan]", default="")
                    ...
                    if phase2_port_scanning.display_phase2_tool_selection_menu(
                        ...
                        if p2_res.get("open_ports_by_host"):
                            ...
                            msg = "[yellow]Nie znaleziono otwartych portów (lub wystąpił błąd narzędzia).[/yellow]"
                            utils.console.print(Align.center(msg))
                            Prompt.ask("\n[bold cyan]Naciśnij Enter, aby powrócić do menu...[/bold cyan]", default="")
                    choice = ""
